        ...
        <div class="col-2">
            <div class="form-group">
                <select name="status" class="form-control">
                    ...
                    <option value="7" {{ old('status', request()->input('status')) == '7' ? 'selected' : '' }}>Returned order</option>
                    <option value="8" {{ old('status', request()->input('status')) == '8' ? 'selected' : '' }}>Refunded</option>
                </select>
            </div>
        </div>
        <div class="col-2">
