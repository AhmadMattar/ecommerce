...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit Review {{ $productReview->code }}</h6>
            <div class="ml-auto">
            ...
            <form action="{{ route('admin.product_reviews.update', $productReview->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" value="{{old('name', $productReview->name)}}" class="form-control">
                            @error('name') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                    </div>
                    <div class="col-4">
                        <label for="email">Email</label>
                        <input type="text" name="email" id="email" value="{{old('email', $productReview->email)}}" class="form-control">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input name="title" value="{{old('title', $productReview->title)}}" class="form-control">
