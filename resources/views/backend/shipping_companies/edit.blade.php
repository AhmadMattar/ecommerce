                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="code" id="code" value="{{old('code', $shipping_company->code)}}" class="form-control">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select name="fast" class="form-control">
                                <option value="1" {{old('fast', $shipping_company->fast) == '1' ? 'selected' : null}}>Fast</option>
                                <option value="0" {{old('fast', $shipping_company->fast) == '0' ? 'selected' : null}}>Regular</option>
                            </select>
