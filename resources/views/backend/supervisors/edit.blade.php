                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="password" value="{{old('password', $supervisor->password)}}" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select name="permissions[]" class="form-control select-multiple-tags" multiple="multiple">
                                @forelse($permissions as $permission)
                                    <option value="{{ $permission->id }}" {{ in_array($permission->id, old('permissions', $supervisorPermission)) ? 'selected' : null }} }}>{{ $permission->display_name }}</option>
                                @empty
                                @endforelse
                            </select>
    ...
    $(function(){
       ...
       $("#supervisor-image").fileinput({
           ...
           initialPreview: [
               ...
               "{{ asset('uploads/users/'.$supervisor->user_image) }}"
               @endif
           ],
