<div x-data="{showForm: @entangle('showForm')}">
    ...
    <form wire:submit.prevent="storeAddress()" x-show="showForm" @click.away="showForm = false">
        @if ($editMode)
        ...
        <div class="row">
            ...
            <div class="col-lg-12 form-group">
                @if($editMode)
                    <button class="btn btn-dark" type="button" wire:click.prevent="updateAddress()">Update address</button>
                @else
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <button type="button" wire:click.prevent="editAddress('{{ $address->id }}')" class="btn btn-success">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" wire:click.prevent="deleteAddress('{{ $address->id }}')" class="btn btn-danger">
