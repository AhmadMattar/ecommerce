                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $order->currency() . ' ' . number_format($product->price * $product->pivot->quantity) }}</td>
                        </tr>
                        @endforeach
                        <tr>
                        ...
                        <tr>
                            <td colspan="3" class="text-right"><strong>Discount</strong> <smal>({{ $order->discount_code }})</smal></td>
                            <td>{{ $order->currency() . ' ' . number_format($order->subtotal, 2) }}</td>
                        </tr>
                        @endif
                        <tr>
