                    ...
                    <div class="product text-center">
                        <div class="position-relative mb-3">
                            ...
                            <a class="d-block" href="{{route('frontend.product', $featuredProduct->slug)}}">
                                <img class="img-fluid w-100" src="{{asset('uploads/products/' . $featuredProduct->firstMedia->file_name)}}" alt="{{$featuredProduct->name}}">
                            </a>
                            <div class="product-overlay">
                                <ul class="mb-0 list-inline">
                                    ...
                                    <li class="list-inline-item m-0 p-0">
                                        <a wire:click.prevent="addToCart('{{ $featuredProduct->id }}')" class="btn btn-sm btn-dark">
                                            Add to cart
                                        </a>
                                    </li>
