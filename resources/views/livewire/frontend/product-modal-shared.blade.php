                            ...
                            @foreach ($productModal->media as $media)
                                @if ($loop->first)
                                    <a class="product-view d-block h-100 bg-cover bg-center"
                                        style="background: url({{asset('uploads/products/'. $media->file_name)}})"
                                        href="{{asset('uploads/products/'. $media->file_name)}}"
                                    ...
                                    @if ( $productModal->reviews_avg_rating != '')
                                        @for ($i =0; $i < 5; $i++)
                                            <li class="list-inline-item m-0">
                                                <i class="{{round($productModal->reviews_avg_rating) <= $i ? 'far' : 'fas'}}
